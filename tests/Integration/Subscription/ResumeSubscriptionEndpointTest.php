...
describe('POST /subscription/resume', function (): void {
    it('rejects when token is not provided', function (): void {
        postJson(getUrl('subscription.resume'))
    ...
    it('skips resuming in case subscription is not on grace period', function (): void {
        $mockPaymentMethodType = 'silver';
        $stripeMock = Mockery::mock(StripeClient::class);
    ...
    it('resumes subscription', function (): void {
        $mockPaymentMethodType = 'silver';
        $stripeMock = Mockery::mock(StripeClient::class);
